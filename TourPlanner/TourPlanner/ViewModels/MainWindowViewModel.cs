...
namespace TourPlanner.ViewModels
{
    public class MainWindowViewModel : BaseViewModel
    {
	    ...
	    public MainWindowViewModel(SearchBarViewModel searchBarViewModel, MenuStripViewModel menuStripViewModel, TourListViewModel tourListViewModel, TourDetailsViewModel tourDetailsViewModel, LogListViewModel logListViewModel) {
